...
open class SimpleButton: UIButton {
    ...
    fileprivate lazy var backgroundColors: [ControlState: SimpleButtonStateChangeValue<CGColor>] = {
        if let color = self.backgroundColor?.cgColor {
            return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: color, animated: true, animationDuration: self.defaultAnimationDuration)]
        }
        return [:]
    }()
    ...
    fileprivate lazy var buttonScales: [ControlState: SimpleButtonStateChangeValue<CGFloat>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: 1.0, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()

    fileprivate lazy var borderWidths: [ControlState: SimpleButtonStateChangeValue<CGFloat>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: self.layer.borderWidth, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()

    fileprivate lazy var cornerRadii: [ControlState: SimpleButtonStateChangeValue<CGFloat>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: self.layer.cornerRadius, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()
    ...
    fileprivate lazy var shadowOpacities: [ControlState: SimpleButtonStateChangeValue<Float>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: self.layer.shadowOpacity, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()

    fileprivate lazy var shadowOffsets: [ControlState: SimpleButtonStateChangeValue<CGSize>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: self.layer.shadowOffset, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()

    fileprivate lazy var shadowRadii: [ControlState: SimpleButtonStateChangeValue<CGFloat>] = {
        return [UIControlState().rawValue: SimpleButtonStateChangeValue(value: self.layer.shadowRadius, animated: true, animationDuration: self.defaultAnimationDuration)]
    }()
    ...
    */
    open func setScale(_ scale: CGFloat, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setBackgroundColor(_ color: UIColor, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setBorderWidth(_ width: CGFloat, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setBorderColor(_ color: UIColor, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setCornerRadius(_ radius: CGFloat, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setShadowColor(_ color: UIColor, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setShadowOpacity(_ opacity: Float, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setShadowRadius(_ radius: CGFloat, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    /**
     ...
     - parameter animationDuration: set this value if you need a specific animation duration for this specific state change. If this is nil, the animation duration is taken from `defaultAnimationDuration`
     */
    open func setShadowOffset(_ offset: CGSize, forState state: UIControlState = UIControlState(), animated: Bool = true, animationDuration: TimeInterval? = nil) {
    ...
    */
    ...
    fileprivate func updateCornerRadius() {
        if let stateChange = cornerRadii[state.rawValue] ?? cornerRadii[UIControlState().rawValue] , stateChange.value != layer.cornerRadius {
            if stateChange.animated && !lockAnimatedUpdate {
                animateLayer(layer, from: sourceLayer.cornerRadius as AnyObject?, to: stateChange.value as AnyObject, forKey: "cornerRadius", duration: stateChange.animationDuration)
            }
    ...
    fileprivate func updateScale() {
        if let stateChange = buttonScales[state.rawValue] ?? buttonScales[UIControlState().rawValue] , transform.a != stateChange.value && transform.b != stateChange.value {
            let animations = {
    ...
    fileprivate func updateBackgroundColor() {
        if let stateChange = backgroundColors[state.rawValue] ?? backgroundColors[UIControlState().rawValue] , layer.backgroundColor == nil || UIColor(cgColor: layer.backgroundColor!) != UIColor(cgColor: stateChange.value) {
            if stateChange.animated && !lockAnimatedUpdate {
    ...
    fileprivate func updateBorderColor() {
        if let stateChange = borderColors[state.rawValue] ?? borderColors[UIControlState().rawValue] , layer.borderColor == nil || UIColor(cgColor: layer.borderColor!) != UIColor(cgColor: stateChange.value)  {
            if stateChange.animated && !lockAnimatedUpdate {
    ...
    fileprivate func updateBorderWidth() {
        if let stateChange = borderWidths[state.rawValue] ?? borderWidths[UIControlState().rawValue] , stateChange.value != layer.borderWidth {
            if stateChange.animated && !lockAnimatedUpdate {
                animateLayer(layer, from: sourceLayer.borderWidth as AnyObject?, to: stateChange.value as AnyObject, forKey: "borderWidth", duration: stateChange.animationDuration)
            }
    ...
    fileprivate func updateShadowOffset() {
        if let stateChange = shadowOffsets[state.rawValue] ?? shadowOffsets[UIControlState().rawValue] , stateChange.value != layer.shadowOffset {
            if stateChange.animated && !lockAnimatedUpdate {
    ...
    fileprivate func updateShadowColor() {
        if let stateChange = shadowColors[state.rawValue] ?? shadowColors[UIControlState().rawValue] , layer.shadowColor == nil || UIColor(cgColor: layer.shadowColor!) != UIColor(cgColor: stateChange.value)  {
            if stateChange.animated && !lockAnimatedUpdate {
    ...
    fileprivate func updateShadowRadius() {
        if let stateChange = shadowRadii[state.rawValue] ?? shadowRadii[UIControlState().rawValue] , stateChange.value != layer.shadowRadius {
            if stateChange.animated && !lockAnimatedUpdate {
                animateLayer(layer, from: sourceLayer.shadowRadius as AnyObject?, to: stateChange.value as AnyObject, forKey: "shadowRadius", duration: stateChange.animationDuration)
            }
    ...
    fileprivate func updateShadowOpacity() {
        if let stateChange = shadowOpacities[state.rawValue] ?? shadowOpacities[UIControlState().rawValue] , stateChange.value != layer.shadowOpacity {
            if stateChange.animated && !lockAnimatedUpdate {
                animateLayer(layer, from: sourceLayer.shadowOpacity as AnyObject?, to: stateChange.value as AnyObject, forKey: "shadowOpacity", duration: stateChange.animationDuration)
            }
    ...
    fileprivate func animateLayer(_ layer: CALayer, from: AnyObject?, to: AnyObject, forKey key: String, duration: TimeInterval) {
